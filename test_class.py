...
class TestClass:
	...
	def test_w_spare_in_the_end(self):
		game = BowlingGame()
	...
	def test_w_strike_in_the_end(self):
		game = BowlingGame()
		self.roll_same_value_n_times(game, value=0, n=2*9)
		game.roll(10)
		game.roll(10)
